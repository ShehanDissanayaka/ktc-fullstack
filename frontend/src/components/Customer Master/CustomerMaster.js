            ...
            <div className="form-grid">
                ...
                <div className="form-col">
                    ...
                    <div className="form-row">
                        ...
                        <input name="telephone1" value={formData.telephone1} onChange={handleChange} />
                    </div>
                    <div className="form-row">
                ...
                <div className="form-col">
                    ...
                    <div className="form-row">
                        ...
                        <input name="creditLimit" value={formData.creditLimit} onChange={handleChange} />
                    </div>
                    <div className="form-row">
                        <label>Credit Period (Days)</label>
                        <input name="creditPeriod" value={formData.creditPeriod} onChange={handleChange} />
                    </div>
                    <div className="form-row">
                        <label>VAT Reg. Number</label>
                        <input name="vatNumber" value={formData.vatNumber} onChange={handleChange} />
                    </div>
                    <div className="form-row">
                    ...
                    <div className="form-row checkbox">
                        <label>Lock</label>
                        <input type="checkbox" name="lock" checked={formData.lock} onChange={handleChange} />
                    </div>
                </div>
            </div>
